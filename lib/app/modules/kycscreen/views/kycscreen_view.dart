                      ...
                      builder: (logic) {
                        return Column(
                          children: [
                            ElevatedButton(
                              onPressed: () async {
                                controller.locationDetail = await Get.dialog(
                                  MapPopup(),
                          ...
                          children: [
                           ...
                           /* CommonTextFieldView(
                            ...
                            CommonTextFieldView(
                              ...
                              controller: controller.address1VehicleController,
                              padding: const EdgeInsets.only(
                                  left: 0, right: 0, bottom: 2, top: 0),
                              hintText: "enter your Address1",
                              keyboardType: TextInputType.text,
                            ...
                            CommonTextFieldView(
                              ...
                              controller: controller.address2VehicleController,
                              padding: const EdgeInsets.only(
                                  left: 0, right: 0, bottom: 2),
                              hintText: "enter your Address2",
                              keyboardType: TextInputType.text,
                            ...
                            CommonTextFieldView(
                              ...
                              controller: controller.cityVehicleController,
                              padding: const EdgeInsets.only(
                                  left: 0, right: 0, bottom: 2),
                              hintText: "enter your City",
                              keyboardType: TextInputType.text,
                            ...
                            CommonTextFieldView(
                              ...
                              controller: controller.stateVehicleController,
                              padding: const EdgeInsets.only(
                                  left: 0, right: 0, bottom: 2),
                              hintText: "enter your State",
                              keyboardType: TextInputType.text,
                            ...
                            CommonTextFieldView(
                              ...
                              controller: controller.countryVehicleController,
                              padding: const EdgeInsets.only(
                                  left: 0, right: 0, bottom: 2),
                              hintText: "enter your Country",
                              keyboardType: TextInputType.text,
