...
class UpComingRideDetailsPageView extends GetView<UpComingRideDetailsPageController> {
  UpComingRideDetailsPageView({Key? key}) : super(key: key);

  UpComingRideDetailsPageController controllerX =
      Get.put<UpComingRideDetailsPageController>(UpComingRideDetailsPageController());
          ...
          children: <Widget>[
            ...
            Expanded(
              child: GetBuilder<UpComingRideDetailsPageController>(
                ...
                builder: (controllerX) {
                  return Container(
                    child: (controllerX.ridesData != null)
                        ? Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        Row(
                                          children: [
                                            Text(
                                                "${controllerX.ridesData?.fromDate ?? ""} to ${controllerX.ridesData?.toDate ?? "" ?? "...."}",
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                    ...
                                                    child: FittedBox(
                                                      ...
                                                      child: Text(
                                                        "₹ ${controllerX.ridesData?.totalAmount ?? 0}",
                                                        style: TextStyles(context)
                                                            .getBoldStyle()
                                                            .copyWith(
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                    ...
                                                    child: FittedBox(
                                                      fit: BoxFit.scaleDown,
                                                      child: Text(
                                                        "₹ ${controllerX.ridesData?.amountPaid ?? 0}",
                                                        style: TextStyles(context)
                                                            .getBoldStyle()
                                                            .copyWith(
                                                                color: Colors.blue, fontSize: 10),
