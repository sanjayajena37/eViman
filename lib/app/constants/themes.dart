...
class AppTheme {
  ...
  static const subtittleTextColor = Color(0xFF3E4958);
  // colors
  ...
  static Color get eVimanSecondaryTextColor => const Color(0xFF2877F0);
  ...
  static Color getColor(ColorType colordata) {
    switch (colordata) {
      case ColorType.verdigris:
        return isLightMode ? const Color(0xFFF51620) : const Color(0xFF4FBE9F);
      ...
      case ColorType.eViman:
        return isLightMode ? const Color(0xFFF51620) : const Color(0xFFff5f5f);
    }
  }
